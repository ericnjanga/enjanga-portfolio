...
export default async function Page() {
  ...
  const dataBanner: ContextType1 = await getDataEntry(
    'BannerBlogPage Entry' as DataFor1
  );
  ...
  const dataListOfEntries: ContextType4 = {
    items: posts
      ...
      .map((post) => ({
        ...
        businessDomain: post.businessDomain,
        techstack: post.techstack,
        introVideo: post.introVideo,
        introVideoImage: post.introVideoImage,
      })),
  };

  return <PageListing banner={dataBanner} listOfEntries={dataListOfEntries} />;
}
