...
export default function GlobalActionsInner() {
  return (
    <>
      <HeaderGlobalAction aria-label="Language translation" tooltipAlignment="center" className="action-icons">
        <Translate size={20} />
      </HeaderGlobalAction>
      <HeaderGlobalAction aria-label="Switch to dark mode" tooltipAlignment="center" className="action-icons">
