...
import type { SiteSettingsData, LinkData, NavigationItemData, HomePageData, ImageData } from '../models'; 
...
export const homePageFallback: HomePageData = {
  ...
  expertiseSection: {
    ...
    expertiseItemsCollection: {
      items: [
        { title: 'Web Development', description: 'Building responsive and dynamic web applications.' },
        { title: 'UI/UX Design', description: 'Creating user-friendly interfaces and experiences.' },
        { title: 'Content Management', description: 'Managing and optimizing content for the web.' },
      ],
    },
  },
  aboutSection: {
        ...
        content: [
          {
            ...
            content: [
              {
                nodeType: 'text',
                value: 'I am a passionate web developer with experience in building modern web applications. I specialize in creating responsive designs and seamless user experiences.',
                marks: [],
                data: {},
              },
            ],
